<div class="relative mx-auto w-full">
    <a href="detail/{{ $favorite->advertisement->id }}" class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
      <div class="shadow p-4 rounded-lg bg-white">
        ...
        <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
          <table class="table-fixed">
            <tbody>
                @foreach($favorite->advertisement->specifications as $specification)
                    <tr>
        ...
        <div class="grid grid-cols-2 mt-8">
          <div class="flex items-center">
            <div class="relative">
              <div class="rounded-full w-6 h-6 md:w-8 md:h-8 bg-gray-200">
                  <img class="rounded-full w-6 h-6 md:w-8 md:h-8" src="images/users/{{ $favorite->advertisement->user->path }}">
              </div>
            ...
            <p class="ml-2 text-gray-800 whitespace-nowrap line-clamp-1">
              {{ $favorite->advertisement->user->first_name }} {{ $favorite->advertisement->user->prefix_name }} {{ $favorite->advertisement->user->last_name }}
            </p>
          </div>
          ...
          <div class="flex justify-end">
            <p class="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
              ...
              <span class="text-lg">{{ $favorite->advertisement->price }}</span>
            </p>
          </div>
        </div>
      </div>
